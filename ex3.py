...
app = dash.Dash(
    __name__, external_stylesheets=['https://codepen.io/amyoshino/pen/jzXypZ.css"']
)
...
app.layout = html.Div(
    html.Div(
        [
            html.Div(
                [
                    html.H1(children="Hello World", className="nine columns"),
                    html.Img(
            ...
            html.Div(
                [
                    html.Div([dcc.Graph(id="example-graph")], className="six columns"),
                    html.Div(
                        [
                            dcc.Graph(
                                id="example-graph-2",
...
def update_image_src(selector):
    ...
    figure = {
        ...
        "layout": {
            ...
            "yaxis": dict(
                title="y Axis",
                titlefont=dict(family="Helvetica, monospace", size=20, color="#7f7f7f"),
            ),
        },
    }
    return figure
